...
import { AbsoluteCenter, Button, Flex, FormControl, FormErrorMessage, FormLabel, Heading, Input, Link, Spacer, VStack, Text, InputGroup, InputRightElement, Alert, AlertIcon } from "@chakra-ui/react";
...
export default function SignUpForm() {
    ...
    return (<Box position={'relative'} h={'calc(100vh - 140px)'}>
            ...
            console.log(values);
            const res = yield fetch('http://localhost:3301/auth/register', {
                method: 'POST',
                headers: {
            ...
            return errors;
                ...
                <Alert status="error">
                                ...
                                <Field name="reenterPassword" type="password">
                                    {({ field, form }) => (<FormControl isInvalid={form.errors.reenterPassword && form.touched.reenterPassword}>
                                ...
                                <Button mt={4} variant={'primary'} colorScheme={'teal'} isLoading={isSubmitting} type={'submit'}>
                                    Submit
                                </Button>
                ...
                <Box position={'absolute'} bottom={'-155px'} left={'0'} w={'100%'}>
                    <Flex>
